...
class _CoinControlViewState extends ConsumerState<CoinControlView> {
  ...
  Widget build(BuildContext context) {
    ...
    final CCFilter _filter = _isSearching
        ? CCFilter.all
        : _showBlocked
        ? CCFilter.frozen
        : CCFilter.available;
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: _isSearching
                ...
                : Text("Coin control", style: STextStyles.navBarTitle(context)),
            titleSpacing: 0,
                              ...
                              : Expanded(
                                  child: ListView.separated(
                                    ...
                                    separatorBuilder: (context, _) =>
                                        const SizedBox(height: 10),
                                    itemBuilder: (context, index) {
                                      final entry = _map!.entries.elementAt(
                                        index,
                                      );
                                      final _controller =
                                          ...
                                          return UtxoCard(
                                            ...
                                            onSelectedChanged: (value) {
                                              if (value) {
                                                utxo.isBlocked
                                                    ? _selectedBlocked.add(utxo)
                                                    : _selectedAvailable.add(
                                                        utxo,
                                                      );
                                              } else {
                                                utxo.isBlocked
                                                    ? _selectedBlocked.remove(
                                                        utxo,
                                                      )
                                                    : _selectedAvailable.remove(
                                                        utxo,
                        ...
                        onPressed: () async {
                          if (_showBlocked) {
                            await MainDB.instance.putUTXOs(
                              _selectedBlocked
                                  .map((e) => e.copyWith(isBlocked: false))
                                  .toList(),
                            );
                            ...
                            await MainDB.instance.putUTXOs(
                              _selectedAvailable
                                  .map((e) => e.copyWith(isBlocked: true))
                                  .toList(),
                            );
                            _selectedAvailable.clear();
                          }
                                    ...
                                    children: [
                                      ...
                                      Builder(
                                        builder: (context) {
                                          ...
                                          final selectedSum = selectedSumInt
                                              .toAmountAsRaw(
                                                fractionDigits:
                                                    coin.fractionDigits,
                                              );
