        ...
        RoundedWhiteContainer(
          ...
          child: Column(
            children: [
              ...
              if (ref.watch(
                desktopExchangeModelProvider.select(
                  (value) => value?.recipientExtraId?.isNotEmpty ?? false,
                ),
              ))
                Container(
                  height: 1,
              ...
              if (ref.watch(
                ...
                DesktopStepItem(
                  label: "Recipient memo / tag",
                  value: ref.watch(
                    desktopExchangeModelProvider.select(
                      (value) => value!.recipientExtraId!,
                    ),
                  ),
                ),
              ...
              if (ref.watch(efExchangeProvider).supportsRefundAddress &&
                  ref.watch(
                    desktopExchangeModelProvider.select(
                      (value) => value?.refundExtraId?.isNotEmpty ?? false,
                    ),
                  ))
                Container(
                  height: 1,
