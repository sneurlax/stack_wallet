...
final Amount DUST_LIMIT = Amount(
  ...
  fractionDigits: Coin.cyberyen.decimals,
);
...
const String GENESIS_HASH_MAINNET =
    "34458c96bb547193fa90b2f2599056684b0083d8a2996f2025943eb545031d29";
const String GENESIS_HASH_TESTNET =
    "fc87d3af1c388f561386e08cfb74819cc04cf33ddb6c39f0bfb685048d3dfb2a";

final cyberyenMainNetwork = NetworkType(
...
final cyberyenTestNetwork = NetworkType(
  messagePrefix: '\x19Cyberyen Signed Message:\n',
  bech32: 'tcy',
  bip32: Bip32Type(
    public: 0x043587cf,
...
String constructDerivePath({
  ...
  switch (networkWIF) {
    ...
    case 0xf0:
      ...
      break;
    default:
      throw Exception("Invalid cyberyen network wif used!");
  }
...
class CyberyenWallet extends CoinServiceAPI
  ...
  NetworkType get _network {
    switch (coin) {
      case Coin.cyberyen:
        return cyberyenMainNetwork;
      // case Coin.cyberyenTestNet:
      //   return cyberyenTestNetwork;
      default:
    ...
    try {
      ...
      if (!integrationTestFlag) {
        ...
        switch (coin) {
          ...
          default:
            throw Exception(
                "Attempted to generate a CyberyenWallet using a non cyberyen coin type: ${coin.name}");
        }
  ...
  ///
  /// Returns the scripthash or throws an exception on invalid cyberyen address
  String _convertToScriptHash(String cyberyenAddress, NetworkType network) {
    try {
      final output = Address.addressToOutputScript(
          cyberyenAddress, network, _network.bech32!);
